...
assert 'olive-splash.png' not in qrc and 'rb-videofire.png' in qrc
...
# 2.2 exposes the existing PreCache operation; it is a render cache, not a true media proxy.
assert 'Create Render Cache' in explorer or 'Create Proxy Cache' in explorer
